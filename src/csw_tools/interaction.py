...
Currently, this script does not allow non-interactive execution, as most commands
will likely need to be verified by user feedback. This safeguard should generally
be used in most or all places.
"""
